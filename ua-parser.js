...
(function (window, undefined) {
    ...
    var defaultRegexes = {
        ...
        device: [
            ...
            [
                MODEL,
                [TYPE, strMapper, { mobile: "Mobile", xr: "VR", "*": TABLET }],
            ],
            [
            ...
            IData.prototype.is = function (strToCheck) {
                ...
                for (var i in this) {
                    if (
                        ...
                        lowerize(
                            is_ignoreRgx
                                ? strip(is_ignoreRgx, this[i])
                                : this[i]
                        ) ==
                            lowerize(
                                is_ignoreRgx
                                    ? strip(is_ignoreRgx, strToCheck)
                                    : strToCheck
                            )
                    ) {
                        is = true;
            ...
            switch (this.itemType) {
                ...
                case UA_OS:
                    ...
                    if (osName) {
                        ...
                        if (osName == WINDOWS)
                            osVersion =
                                parseInt(majorize(osVersion), 10) >= 13
                                    ? "11"
                                    : "10";
